  ...
  <form action="#" method="POST">
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" id="name" name="name" placeholder="Informe o nome" class="form-control" value="<?= $name ?>">
      </div>
      <div class="form-group col-md-6">
        <label for="email">E-mail</label>
        <input type="email" id="email" name="email" placeholder="Informe o email" class="form-control" value="<?= $email ?>">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
